...
class SignInViewController: UIViewController {
    ...
    private var authenticationProvider: AuthenticationProvider = GoogleAuthenticationProvider()
    ...
    @objc func signIn() {
        ...
        authenticationProvider.signIn(email: email, password: password) { result in
            switch result {
