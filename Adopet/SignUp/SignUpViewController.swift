...
class SignUpViewController: UIViewController {
    ...
    private lazy var emailInputField: APLabeledTextField = {
        let inputField = APLabeledTextField(title: "Email", placeholder: "Escolhe seu melhor email")
    ...
    private lazy var phoneNumberInputField: APLabeledTextField = {
       let inputField = APLabeledTextField(title: "Telefone com DDD", placeholder: "Insira seu telefone/whatapp")
    ...
    @objc func signUpButton() {
        ...
        guard let name = nameInputField.textField.text,
              ...
              let password = passwordInputField.textField.text else {
            return
        }
